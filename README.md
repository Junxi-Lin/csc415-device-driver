...
Because this is a newer version of the OS than prior semesters, there have been some changes which require you execute the following two lines in you Ubuntu terminal window before you start this project.
...
**NOTE:**
No tic-tac-toe, basic calculator, string reversal or palindrome allowed!
